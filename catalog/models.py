...
class Book(models.Model):
    ...
    # Foreign Key used because book can only have one auhor, but authors
...
class BookInstance(models.Model):
    ...
    def display_due_back_date(self):
        return self.due_back and self.due_back.strftime("%m %d, %Y")
...
class Language(models.Model):
    ...
    name = models.CharField(max_length=200, help_text="Enter the book's language (e.g. French)")
